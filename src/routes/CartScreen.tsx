									...
									<Card
										...
										<Box
											...
											<Box
												sx={{
													display: 'flex',
													flexDirection: { xs: 'row', sm: 'row' }, // Keep them in a row for all screen sizes
													alignItems: 'center',
													gap: { xs: 2, sm: 1 }, // Set the gap to 16px (2 units in theme spacing) on extra small screens
													mt: 2.5,
													justifyContent: {
														xs: 'center', // Center the elements horizontally on extra small screens
														sm: 'flex-start',
													},
												}}>
												<Select
